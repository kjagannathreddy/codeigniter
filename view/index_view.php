...
-					</div>
                ...
                {
                  ?>
                  <li><a href="my_account"><i class="fa fa-user"></i> <?php echo ucfirst($this->session->userdata('name')); ?></a></li>
                  <?php
                }
                else {
                  ?>
                  <li><a href="index.php/user_controller/login_user"><i class="fa fa-lock"></i> Login</a></li>
                  <?php
                }
                 ?>
							</ul>
			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						...
						<?php
						$count=$recent_items->num_rows();
						if($count>0)
						{
							foreach($recent_items->result() as $row)
							{
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="<?php echo IMG_PATH.$img; ?>" alt="" />
											<h2><?php echo $row->product_mrp; ?></h2>
